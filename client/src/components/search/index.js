...
export const Search = ({setSearch}) => {
    ...
    return (
        ...
        <form className="flex-row-reverse d-flex flex-wrap searchForm">
            ...
            <button type="submit" className="btn btn-dark mx-2 responsiveButton " style={{width:'120px',background:"#fba1b7",fontFamily:'lato',border:0,maxHeight:'45px',margin:'auto 0',height:'46px'}}>Search</button>
        </form>
        </div>
        </div>
